...
namespace XLua
{
    ...
    public partial class StaticLuaCallbacks
    {
        ...
        #if UNITY_EDITOR
        public static bool showStaticCallback = false;
        #endif
        ...
        public static int EnumAnd(RealStatePtr L)
        {
            ...
            #if UNITY_EDITOR
            if (showStaticCallback) 
                TFW.D.Log("xlua_callback: EnumAnd"); 
            #endif
...
#if UNITY_EDITOR
            if (showStaticCallback) 
                TFW.D.Log("xlua_callback: EnumOr"); 
#endif
...
#if UNITY_EDITOR
            if (showStaticCallback) 
                TFW.D.Log("xlua_callback: StaticCSFunction"); 
#endif
...
#if UNITY_EDITOR
            if (showStaticCallback) 
                TFW.D.Log("xlua_callback: FixCSFunction"); 
#endif
...
#if UNITY_EDITOR
            if (showStaticCallback) 
                TFW.D.Log("xlua_callback: DelegateConstructor"); 
#endif

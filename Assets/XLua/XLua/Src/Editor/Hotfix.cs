    ...
    public static class Hotfix
    {
        ...
        public static void HotfixInject()
        {
            ...
            foreach (var injectAssemblyPath in injectAssemblyPaths)
            {
                ...
                hotfix_injection.StartInfo.RedirectStandardError = true;
                ...
                while (!hotfix_injection.HasExited)
                {
                    string output = hotfix_injection.StandardOutput.ReadToEnd();
                    if (String.IsNullOrEmpty(output))
                    {
                        logSB.Append(hotfix_injection.StandardError.ReadToEnd());
                    }
                    else
                    {
                        logSB.Append(output);
                ...
                hotfix_injection.StandardError.Close();
                hotfix_injection.StandardOutput.Close();
                hotfix_injection.Dispose();
            }
